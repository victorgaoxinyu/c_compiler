OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/helpers/buffer.o ./build/helpers/vector.o ./build/lexer.o ./build/token.o ./build/lex_process.o ./build/parser.o
INCLUDES= -I ./
